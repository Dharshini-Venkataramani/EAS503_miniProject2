...
def main():
    ...
    **🤓Sample Queries:**
    - List all customers and the countries they belong to
    - Find total quantity ordered for each product
    - Find total customers per country
    - Show region-wise sales
    """)
    st.sidebar.markdown("---")
    st.sidebar.info("""
        🩼**How it works:**
        1. ⌨️Enter your question in plain English
    ...
    user_question = st.text_area(
        ...
        height=100, 
        placeholder="List all customers and the countries they belong to"
    )
